        ...
        <div className="max-w-[1200px] mx-auto px-6 flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:block">
              <LanguageSwitcher value={language} onChange={(value) => setLanguage(value as "ru" | "kz" | "en")} />
            </div>
              ...
              <div className="relative hidden md:block">
                ...
                >
                  {user?.avatar ? (
                    ...
                    <span className="text-[12px]" style={{ color: "var(--eco-text-secondary)" }}>{initials}</span>
                  )}
                </button>
                {profileOpen && (
                  <>
                    ...
                    >
                      <div className="px-3 py-2">
                        <div className="text-[13px]" style={{ color: "var(--eco-text)" }}>{user?.displayName}</div>
                        <div className="text-[11px]" style={{ color: "var(--eco-text-tertiary)" }}>{user?.email}</div>
                      </div>
