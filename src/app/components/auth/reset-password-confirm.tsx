    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <h1 className="text-[24px]" style={{ color: "var(--eco-text)" }}>Create a new password</h1>
        ...
        <Card>
          {done ? (
            <div className="flex flex-col gap-3 text-center">
              <p className="text-[14px]" style={{ color: "var(--eco-text)" }}>Password updated successfully.</p>
              <p className="text-[12px]" style={{ color: "var(--eco-text-secondary)" }}>Redirecting to sign in...</p>
            </div>
          ) : (
