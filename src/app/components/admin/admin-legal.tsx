...
export function AdminLegalPage() {
  ...
  useEffect(() => { void load(docType); }, [load, docType]);
    ...
    <AdminLayout>
      <div className="max-w-[860px]">
        <div className="flex items-center justify-between gap-3 mb-4 flex-wrap">
          <h1 className="text-[24px]" style={{ color: "var(--eco-text)" }}>{t("adminLegalTitle")}</h1>
          <Button variant="secondary" size="sm" onClick={() => void load(docType)} disabled={loading || saving}>
