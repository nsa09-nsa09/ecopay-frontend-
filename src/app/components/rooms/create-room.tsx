...
import { ArrowLeft, Lock, Check, Shield, CreditCard } from "lucide-react";
import {
  ApiError,
  createRoomRequest,
  getFxRatesRequest,
        ...
        {step === 3 && (
          <Card className="flex flex-col gap-4">
            ...
            <div className="flex gap-3">
              ...
              <Button variant="primary" className="flex-1" loading={submitting} disabled={hasPayoutCard === false} onClick={handlePublish}>
