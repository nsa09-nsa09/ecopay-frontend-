        ...
        {step === 2 && (
          <Card className="flex flex-col gap-4">
            ...
            <div className="flex gap-3">
              ...
              <Button variant="primary" className="flex-1" disabled={!confirmed} onClick={() => setStep(3)}>Continue</Button>
            </div>
          </Card>
        )}
        ...
        {step === 3 && (
          <Card className="flex flex-col gap-4">
            ...
            {[
              ...
              { label: "Access", value: access === "esim" ? "eSIM activation" : access === "sim" ? "Physical SIM" : "Account invite" },
            ].map((row) => (
