...
export function LeaveReviewModal({
  ...
  return (
    <Modal
      open={open}
      onClose={onClose}
      title={tx(language, 'Оставить отзыв', 'Пікір қалдыру', 'Leave a Review')}
    >
      <div className="flex flex-col gap-4">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder={tx(
              language,
              'Поделитесь подробностями вашего опыта',
              'Тәжірибеңіздің егжей-тегжейімен бөлісіңіз',
