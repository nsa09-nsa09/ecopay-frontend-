  ...
  return (
    <div>
      ...
      <SectionCard className="mb-6">
        ...
        <div
          className="hidden sm:grid grid-cols-[180px_180px_200px_1fr] gap-4 text-[11px] pb-3 mb-3"
          ...
          {maskExamples.map((ex) => {
            ...
            return (
              <div key={ex.id}>
                {/* Desktop */}
                <div
                  className="hidden sm:grid grid-cols-[180px_180px_200px_1fr] gap-4 items-center py-2.5"
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <code
                      className="text-[13px]"
                      style={{ color: 'var(--eco-text-tertiary)', textDecoration: 'line-through' }}
                    >
                      {ex.full}
                    </code>
                  </div>
                ...
                {/* Mobile */}
                <div
                  className="sm:hidden rounded-lg p-3"
                ...
                >
                  ...
                  <span
                    className="text-[10px] px-2 py-1 rounded-lg inline-flex items-center gap-1"
                    style={{ background: rc.bg, color: rc.text }}
                  >
                    <Lock size={9} /> {ex.rule}
                  </span>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div
            ...
            style={{
              ...
              border: '1px dashed var(--eco-warning-500)',
            }}
          >
          ...
          <div
            ...
            style={{
              ...
              border: '1px dashed var(--eco-danger-500)',
            }}
          >
          ...
          <div
            ...
            style={{
              ...
              border: '1px dashed var(--eco-neutral-300)',
            }}
          >
        ...
        <SectionCard>
          ...
          <div className="max-w-md">
            ...
            >
              ...
              <div
                className="flex items-center gap-2 mt-4 rounded-lg px-3 py-2"
                style={{
                  background: 'var(--eco-warning-100)',
                  border: '1px dashed var(--eco-warning-500)',
                }}
                ...
                <div className="mb-4">
                  ...
                  <select
                    ...
                    style={{
                      ...
                      border: '1px solid var(--eco-border)',
                      color: reason ? 'var(--eco-text)' : 'var(--eco-text-tertiary)',
                    }}
                  >
      ...
      {step === 'revealed' && (
        <SectionCard>
          ...
          <div className="max-w-md">
            <div
              className="rounded-xl p-5"
              style={{ background: 'var(--eco-bg)', border: '2px solid var(--eco-success-500)' }}
            >
              ...
              <div className="flex flex-col gap-3 mb-4">
                ...
                >
                  <div className="text-[11px] mb-1" style={{ color: 'var(--eco-success-500)' }}>
                    {t('phoneNumber')}
                  </div>
                  <code className="text-[16px]" style={{ color: 'var(--eco-text)' }}>
                    +7 705 123 45 67
                  </code>
                </div>
              </div>
          ...
          <div className="max-w-md">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <div className="text-[16px]" style={{ color: 'var(--eco-danger-500)' }}>
                    {t('accessDenied')}
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-lg p-3 mb-4" style={{ background: 'var(--eco-neutral-100)' }}>
                ...
                <div className="flex items-center gap-2">
                  <code className="text-[15px]" style={{ color: 'var(--eco-text-tertiary)' }}>
                    +7 7** *** ** 67
                  </code>
          ...
          {auditEntries.map((entry, i) => (
            <div key={entry.id}>
              ...
              <div
                ...
                style={{
                  borderBottom:
                    i < auditEntries.length - 1 ? '1px solid var(--eco-border)' : 'none',
                }}
              >
                {/* Timestamp + Actor */}
                <div>
                ...
                {/* Action */}
                <div>
                  <div className="text-[11px] mb-0.5" style={{ color: 'var(--eco-text-tertiary)' }}>
                    {t('auditAction')}
                  </div>
                  <span className="text-[13px]" style={{ color: 'var(--eco-text)' }}>
                    {entry.action}
              ...
              >
                ...
                <code
                  className="text-[10px] px-1.5 py-0.5 rounded inline-block mb-1.5"
                  style={{
                    background: 'var(--eco-neutral-100)',
            ...
            >
              <div className="flex items-center gap-2.5 mb-2">
                <div
                  ...
                  style={{ background: 'var(--eco-brand-100)' }}
                >
                  <MessageSquareOff size={16} style={{ color: 'var(--eco-brand-600)' }} />
                </div>
              ...
              <div className="rounded-lg p-3 mb-3" style={{ background: 'var(--eco-neutral-100)' }}>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <code className="text-[13px]" style={{ color: 'var(--eco-text)' }}>
                      +7 7** *** ** 45
                    </code>
                  </div>
                  <button
