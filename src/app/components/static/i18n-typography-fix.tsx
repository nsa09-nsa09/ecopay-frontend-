...
const i18nKeyMap: { key: string; ru: string; kz: string; en: string; module: string }[] = [
  ...
  {
    key: 'heroTitle',
    ru: 'Делитесь тарифами.',
    kz: 'Тарифтерді бөлісіңіз.',
    en: 'Share plans.',
    module: 'Catalog',
  },
  {
  ...
  {
    key: 'availableRooms',
    ru: 'Доступные комнаты',
    kz: 'Қолжетімді бөлмелер',
    en: 'Available Rooms',
    module: 'Catalog',
  },
  // Rooms
...
export function I18nTypographyFixPage() {
  ...
  const filtered =
    filterModule === 'All' ? i18nKeyMap : i18nKeyMap.filter((k) => k.module === filterModule);
        ...
        <div>
          ...
          >
            ...
            <p className="text-[14px] mb-6" style={{ color: 'var(--eco-text-secondary)' }}>
              Updated from smaller base to 16px for improved readability. All headings scale
              proportionally via CSS custom properties.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
              {[
                ...
                >
                  ...
                  <div className="text-[24px] mb-1" style={{ color: 'var(--eco-primary)' }}>
                    {item.value}
                  </div>
            ...
            >
              <div
                className="grid grid-cols-[1fr_70px_80px_1fr_60px] gap-0 text-[12px] px-4 py-2"
                style={{
              ...
              {typographyScale.map((row) => (
                <div
                  key={row.token}
                  className="grid grid-cols-[1fr_70px_80px_1fr_60px] gap-0 text-[13px] px-4 py-3 items-center"
                  style={{ borderBottom: '1px solid var(--eco-border)' }}
                >
                  <code
                    className="text-[12px] px-1.5 py-0.5 rounded"
                    style={{ background: 'var(--eco-surface)', color: 'var(--eco-primary)' }}
                  >
                    {row.token}
                  </code>
          ...
          <div
            ...
            style={{ background: 'var(--eco-surface)', border: '1px solid var(--eco-border)' }}
          >
            <h3 className="text-[16px] mb-4" style={{ color: 'var(--eco-text)' }}>
              Live Preview
            </h3>
            <div className="flex flex-col gap-3">
              <div className="flex items-baseline gap-3">
                ...
                <span style={{ fontSize: '36px', color: 'var(--eco-text)', lineHeight: 1.2 }}>
                  Hero Title
                </span>
              </div>
              <div className="flex items-baseline gap-3">
                ...
                <span style={{ fontSize: '30px', color: 'var(--eco-text)', lineHeight: 1.2 }}>
                  H1 Heading
                </span>
              </div>
              <div className="flex items-baseline gap-3">
                ...
                <span style={{ fontSize: '24px', color: 'var(--eco-text)', lineHeight: 1.3 }}>
                  H2 Heading
                </span>
              </div>
              <div className="flex items-baseline gap-3">
                ...
                <span style={{ fontSize: '20px', color: 'var(--eco-text)', lineHeight: 1.4 }}>
                  H3 Heading
                </span>
              </div>
              <div className="flex items-baseline gap-3">
                ...
                <span style={{ fontSize: '18px', color: 'var(--eco-text)', lineHeight: 1.5 }}>
                  H4 / Large Body
                </span>
              </div>
              <div className="flex items-baseline gap-3">
              ...
              <div className="flex items-baseline gap-3">
                ...
                <span
                  style={{ fontSize: '14px', color: 'var(--eco-text-secondary)', lineHeight: 1.5 }}
                >
                  Secondary text, captions, helper labels
                </span>
              </div>
              <div className="flex items-baseline gap-3">
                <span
                ...
                <span
                  style={{ fontSize: '12px', color: 'var(--eco-text-tertiary)', lineHeight: 1.4 }}
                >
        ...
        <div>
          ...
          >
            ...
            <p className="text-[14px] mb-4" style={{ color: 'var(--eco-text-secondary)' }}>
              Reference map of translation keys → RU / KZ / EN strings. Total: 250+ keys across all
              modules.
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
              {[
                ...
                <div
                  ...
                  style={{ background: 'var(--eco-bg)', border: '1px solid var(--eco-border)' }}
                >
                  <div className="text-[20px] mb-0.5" style={{ color: 'var(--eco-primary)' }}>
                    {s.value}
                  </div>
            ...
            >
              <div
                className="hidden sm:grid grid-cols-[120px_60px_1fr_1fr_1fr] gap-0 text-[11px] px-4 py-2"
                style={{
                  background: 'var(--eco-bg)',
                  color: 'var(--eco-text-tertiary)',
                  borderBottom: '1px solid var(--eco-border)',
              ...
              <div className="max-h-[480px] overflow-y-auto">
                {filtered.map((row) => (
                  <div key={row.key}>
                    {/* Desktop */}
                    <div
                      className="hidden sm:grid grid-cols-[120px_60px_1fr_1fr_1fr] gap-0 text-[13px] px-4 py-2.5 items-center"
                      style={{ borderBottom: '1px solid var(--eco-border)' }}
                    >
                      <code
                    ...
                    >
                      ...
                      <div className="grid grid-cols-3 gap-2 text-[12px]">
                        <div>
                          <span style={{ color: 'var(--eco-text-tertiary)' }}>RU: </span>
                          <span style={{ color: 'var(--eco-text)' }}>{row.ru}</span>
                        </div>
                        <div>
                          <span style={{ color: 'var(--eco-text-tertiary)' }}>KZ: </span>
                          <span style={{ color: 'var(--eco-text)' }}>{row.kz}</span>
                        </div>
                        <div>
                          <span style={{ color: 'var(--eco-text-tertiary)' }}>EN: </span>
                          <span style={{ color: 'var(--eco-text-secondary)' }}>{row.en}</span>
                        </div>
                      </div>
                    </div>
            ...
            <p className="text-[12px] mt-3" style={{ color: 'var(--eco-text-tertiary)' }}>
              Showing {filtered.length} of {i18nKeyMap.length} sample keys. Full dictionary contains
              367+ entries in i18n-provider.tsx.
            </p>
          </div>
              ...
              {[
                ...
                >
                  <div
                    ...
                    style={{ background: item.done ? 'var(--eco-positive)' : 'var(--eco-border)' }}
                  >
      ...
      {activeSection === 'mobile' && (
        <div>
          ...
          >
            ...
            <p className="text-[14px] mb-6" style={{ color: 'var(--eco-text-secondary)' }}>
              On mobile (&lt;768px), the header shows only: Logo + Search icon + Language chip +
              Menu icon. Full language switching moves into the menu sheet.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
              ...
              <div>
                ...
                >
                  ...
                  >
                    <span className="text-[18px]" style={{ color: 'var(--eco-text)' }}>
                  ...
                  <div
                    className="p-2 text-[11px] text-center"
                    style={{ color: 'var(--eco-negative)', background: 'rgba(239,68,68,0.05)' }}
                  >
              ...
              {/* After */}
              <div>
                <div className="text-[12px] mb-2" style={{ color: 'var(--eco-positive)' }}>
                  AFTER (compact, no overflow)
                </div>
                <div
                  className="rounded-xl overflow-hidden"
                  style={{ border: '2px solid var(--eco-positive)' }}
                >
                  <div
                    className="p-3 flex items-center justify-between"
                    style={{
                  ...
                  <div
                    className="p-2 text-[11px] text-center"
                    style={{ color: 'var(--eco-positive)', background: 'rgba(16,185,129,0.05)' }}
                  >
            ...
            <div>
              <div className="text-[12px] mb-2" style={{ color: 'var(--eco-text-tertiary)' }}>
                MENU SHEET — Language Switcher Inside
              </div>
              <div
              ...
              >
                <div className="p-4" style={{ background: 'var(--eco-bg)' }}>
                    ...
                    <div className="flex gap-2">
                      {[
                        ...
                        <button
                          ...
                          style={{
                            background:
                              l.code === 'ru' ? 'var(--eco-primary)' : 'var(--eco-surface)',
                  ...
                  {['Каталог', 'Мои комнаты', 'Поддержка', 'О нас'].map((item) => (
                    <div
                      key={item}
                      className="px-3 py-2 text-[14px] rounded-lg"
                  ...
                  >
                    ...
                    <button
                      className="flex-1 px-3 py-2 rounded-lg text-[13px]"
                      style={{ background: 'var(--eco-primary)', color: '#fff' }}
                    >
                      Регистрация
                    </button>
                  </div>
              ...
              {[
                ...
                <div key={i} className="flex items-start gap-2.5">
                  <div
                    ...
                    style={{ background: 'var(--eco-positive)' }}
                  >
                    <Check size={12} color="#fff" />
                  </div>
