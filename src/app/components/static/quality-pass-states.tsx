...
const typeConfig: Record<
  StateType,
  { labelKey: string; badgeVariant: 'danger' | 'default' | 'info' | 'warning'; borderColor: string }
> = {
    ...
    auth: [
      {
        ...
        type: 'error',
        titleKey: 'authLoginError',
        descKey: 'authLoginErrorDesc',
        ctaKey: 'authLoginErrorCta',
        ctaVariant: 'ghost',
        icon: XCircle,
      ...
      },
      {
        ...
        moduleKey: 'moduleAuth',
        type: 'error',
        titleKey: 'authRateLimited',
        descKey: 'authRateLimitedDesc',
        ctaKey: 'authRateLimitedCta',
        ctaVariant: 'ghost',
        icon: ShieldAlert,
        iconColor: 'var(--eco-danger-500)',
        iconBg: 'var(--eco-danger-100)',
      ...
      },
      {
        ...
        moduleKey: 'moduleAuth',
        type: 'info',
        titleKey: 'authEmailSent',
        descKey: 'authEmailSentDesc',
        ctaKey: 'authEmailSentCta',
        ctaVariant: 'primary',
        icon: Mail,
    ...
    catalog: [
      {
        ...
        type: 'empty',
        titleKey: 'catalogNoRooms',
        descKey: 'catalogNoRoomsDesc',
        ctaKey: 'catalogNoRoomsCta',
        ctaVariant: 'primary',
        icon: PackageOpen,
        iconColor: 'var(--eco-text-tertiary)',
        iconBg: 'var(--eco-neutral-100)',
      },
      {
        id: 'CAT-EMPTY-02',
        module: 'Catalog',
        moduleKey: 'moduleCatalog',
        type: 'empty',
        titleKey: 'catalogFilterEmpty',
        descKey: 'catalogFilterEmptyDesc',
        ctaKey: 'catalogFilterEmptyCta',
        ctaVariant: 'ghost',
        icon: Search,
        iconColor: 'var(--eco-text-tertiary)',
        iconBg: 'var(--eco-neutral-100)',
    ...
    room: [
      {
        ...
        type: 'error',
        titleKey: 'roomFullState',
        descKey: 'roomFullStateDesc',
        ctaKey: 'roomFullStateCta',
        ctaVariant: 'primary',
        icon: DoorOpen,
      ...
      },
      {
        ...
        moduleKey: 'moduleRoomDetail',
        type: 'error',
        titleKey: 'roomJoinClosed',
        descKey: 'roomJoinClosedDesc',
        ctaKey: 'roomJoinClosedCta',
        ctaVariant: 'ghost',
        icon: Lock,
        iconColor: 'var(--eco-danger-500)',
        iconBg: 'var(--eco-danger-100)',
    ...
    payments: [
      {
        id: 'PAY-ERR-01',
        module: 'Payments',
        moduleKey: 'modulePayments',
        type: 'error',
        titleKey: 'paymentFailed',
        descKey: 'paymentFailedDesc',
        ctaKey: 'paymentFailedCta',
        ctaVariant: 'primary',
        icon: XCircle,
        iconColor: 'var(--eco-danger-500)',
        iconBg: 'var(--eco-danger-100)',
      },
      {
        ...
        moduleKey: 'modulePayments',
        type: 'loading',
        titleKey: 'paymentPendingHold',
        descKey: 'paymentPendingHoldDesc',
        ctaKey: 'paymentPendingHoldCta',
        ctaVariant: 'ghost',
        icon: Hourglass,
        iconColor: 'var(--eco-warning-500)',
        iconBg: 'var(--eco-warning-100)',
      ...
      },
      {
        ...
        moduleKey: 'modulePayments',
        type: 'info',
        titleKey: 'paymentRetrySafe',
        descKey: 'paymentRetrySafeDesc',
        ctaKey: 'paymentRetrySafeCta',
        ctaVariant: 'primary',
        icon: RefreshCw,
        iconColor: 'var(--eco-brand-600)',
        iconBg: 'var(--eco-brand-50)',
    ...
    support: [
      {
        ...
        type: 'empty',
        titleKey: 'supportNoTickets',
        descKey: 'supportNoTicketsDesc',
        ctaKey: 'supportNoTicketsCta',
        ctaVariant: 'primary',
        icon: Inbox,
        iconColor: 'var(--eco-text-tertiary)',
        iconBg: 'var(--eco-neutral-100)',
      },
      {
        ...
        moduleKey: 'moduleSupport',
        type: 'error',
        titleKey: 'supportAttachRejected',
        descKey: 'supportAttachRejectedDesc',
        ctaKey: 'supportAttachRejectedCta',
        ctaVariant: 'ghost',
        icon: FileWarning,
        iconColor: 'var(--eco-danger-500)',
        iconBg: 'var(--eco-danger-100)',
    ...
    admin: [
      {
        id: 'ADM-EMPTY-01',
        module: 'Admin',
        moduleKey: 'moduleAdmin',
        type: 'empty',
        titleKey: 'adminQueueEmpty',
        descKey: 'adminQueueEmptyDesc',
        ctaKey: 'adminQueueEmptyCta',
        ctaVariant: 'ghost',
        icon: CheckCircle2,
        iconColor: 'var(--eco-success-500)',
        iconBg: 'var(--eco-success-100)',
      },
      {
        id: 'ADM-ERR-01',
        module: 'Admin',
        moduleKey: 'moduleAdmin',
        type: 'error',
        titleKey: 'adminPermDenied',
        descKey: 'adminPermDeniedDesc',
        ctaKey: 'adminPermDeniedCta',
        ctaVariant: 'ghost',
        icon: Ban,
        iconColor: 'var(--eco-danger-500)',
        iconBg: 'var(--eco-danger-100)',
        ...
        {(['error', 'empty', 'info', 'loading'] as StateType[]).map((st) => {
          ...
          return (
            <div
              key={st}
              className="rounded-xl p-4 text-center"
              style={{ background: 'var(--eco-surface)', border: `1px solid ${tc.borderColor}` }}
            >
              <div className="text-[24px]" style={{ color: 'var(--eco-text)' }}>
                {byType[st]}
              </div>
          ...
          return (
            ...
            >
              ...
              <span
                ...
                style={{
                  background:
                    activeModule === key ? 'var(--eco-primary)' : 'var(--eco-neutral-200)',
                  color:
                    activeModule === key
              ...
              <thead>
                <tr style={{ background: 'var(--eco-bg)' }}>
                  ...
                  {(['error', 'empty', 'info', 'loading'] as StateType[]).map((st) => (
                    ...
                    >
                      <Badge variant={typeConfig[st].badgeVariant}>
                        {t(typeConfig[st].labelKey)}
                      </Badge>
                    </th>
                  ))}
                </tr>
            ...
            {modules.map(({ key, labelKey }) => (
              <div key={key} className="mb-4">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {(cards[key] || []).map((c) => (
                    <Badge key={c.id} variant={typeConfig[c.type].badgeVariant}>
                      {t(c.titleKey)}
                    </Badge>
                  ))}
                </div>
