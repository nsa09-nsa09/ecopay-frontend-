...
import {
  ArrowRight, Clock, AlertTriangle, ShieldAlert, CheckCircle2, XCircle,
  Ban, Timer, FileWarning, TicketCheck, RefreshCw, Eye, ChevronRight,
  Info, AlertCircle, Shield, Zap, Pause, MessageSquareWarning,
} from "lucide-react";
...
function StateNode({
  ...
  const colors: Record<string, { bg: string; border: string; text: string }> = {
    info: { bg: "var(--eco-brand-50)", border: "var(--eco-brand-400)", text: "var(--eco-brand-600)" },
    warning: { bg: "var(--eco-warning-100)", border: "var(--eco-warning-500)", text: "var(--eco-warning-500)" },
    success: { bg: "var(--eco-success-100)", border: "var(--eco-success-500)", text: "var(--eco-success-500)" },
    danger: { bg: "var(--eco-danger-100)", border: "var(--eco-danger-500)", text: "var(--eco-danger-500)" },
    default: { bg: "var(--eco-neutral-100)", border: "var(--eco-neutral-300)", text: "var(--eco-text-secondary)" },
  };
    ...
    <div>
      ...
      <SectionCard className="mb-6">
        ...
        <div className="hidden md:flex items-center gap-3 ml-8 mt-2">
          <span className="text-[11px]" style={{ color: "var(--eco-text-tertiary)" }}>+</span>
      ...
      <SectionCard>
        <div className="flex items-center gap-3 mb-4">
          <div
            ...
            style={{
              background: current.variant === "info" ? "var(--eco-brand-50)" :
                current.variant === "warning" ? "var(--eco-warning-100)" :
                current.variant === "success" ? "var(--eco-success-100)" :
                current.variant === "danger" ? "var(--eco-danger-100)" : "var(--eco-neutral-100)",
            }}
          >
            <Icon size={20} style={{
              color: current.variant === "info" ? "var(--eco-brand-600)" :
                current.variant === "warning" ? "var(--eco-warning-500)" :
                current.variant === "success" ? "var(--eco-success-500)" :
                current.variant === "danger" ? "var(--eco-danger-500)" : "var(--eco-text-secondary)",
            }} />
          </div>
          <div>
            <div className="text-[16px]" style={{ color: "var(--eco-text)" }}>{current.label}</div>
            <code className="text-[11px]" style={{ color: "var(--eco-text-tertiary)" }}>{current.id}</code>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {/* Allowed Actions */}
          <div className="rounded-lg p-4" style={{ background: "var(--eco-bg)", border: "1px solid var(--eco-border)" }}>
            <div className="text-[11px] mb-2" style={{ color: "var(--eco-text-tertiary)" }}>
              {t("allowedActions").toUpperCase()}
            </div>
            <div className="flex flex-col gap-1.5">
              {current.actions.map((a, i) => (
                <div key={`${current.id}-action-${i}`} className="flex items-center gap-2 text-[13px]" style={{ color: "var(--eco-text-secondary)" }}>
    ...
    <div>
      ...
      <SectionCard className="mb-6">
        <div className="flex items-center gap-3 mb-4">
          <div className="text-[16px]" style={{ color: "var(--eco-text)" }}>{current.label}</div>
          <code className="text-[11px]" style={{ color: "var(--eco-text-tertiary)" }}>{current.id}</code>
          <div className="ml-auto"><MemberStatusBadge status={current.id} /></div>
        </div>
        <p className="text-[14px] mb-5" style={{ color: "var(--eco-text-secondary)" }}>{current.desc}</p>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="rounded-lg p-4" style={{ background: "var(--eco-bg)", border: "1px solid var(--eco-border)" }}>
            <div className="text-[11px] mb-2" style={{ color: "var(--eco-text-tertiary)" }}>{t("allowedActions").toUpperCase()}</div>
            {current.actions.length > 0 ? current.actions.map((a, i) => (
              <div key={`${current.id}-ma-${i}`} className="flex items-center gap-2 text-[13px] mb-1" style={{ color: "var(--eco-text-secondary)" }}>
                <ChevronRight size={12} style={{ color: "var(--eco-text-tertiary)" }} /> {a}
              </div>
            )) : <span className="text-[13px]" style={{ color: "var(--eco-text-tertiary)" }}>—</span>}
          </div>
          <div className="rounded-lg p-4" style={{ background: "var(--eco-bg)", border: "1px solid var(--eco-border)" }}>
            <div className="text-[11px] mb-2" style={{ color: "var(--eco-text-tertiary)" }}>{t("primaryCta").toUpperCase()}</div>
            <Button variant="primary" size="sm" disabled>{current.cta}</Button>
          </div>
          <div className="rounded-lg p-4" style={{ background: "var(--eco-bg)", border: "1px solid var(--eco-border)" }}>
            <div className="text-[11px] mb-2" style={{ color: "var(--eco-text-tertiary)" }}>{t("transitionsTo").toUpperCase()}</div>
            {current.transitions.length > 0 ? (
              <div className="flex flex-wrap gap-1.5">
                {current.transitions.map((tid) => {
                  const ts = states.find((x) => x.id === tid)!;
            ...
            ) : <span className="text-[13px]" style={{ color: "var(--eco-text-tertiary)" }}>— (terminal)</span>}
          </div>
        </div>
      </SectionCard>
      ...
      {/* Rules */}
      <SectionCard>
        <div className="text-[12px] mb-3" style={{ color: "var(--eco-text-tertiary)" }}>BUSINESS RULES</div>
        <div className="flex flex-col gap-3">
          {[
            ...
            <div
              ...
              style={{
                background: rule.variant === "info" ? "var(--eco-brand-50)" :
                  rule.variant === "warning" ? "var(--eco-warning-100)" : "var(--eco-danger-100)",
              }}
            >
              <rule.icon
                size={16}
                ...
                style={{
                  color: rule.variant === "info" ? "var(--eco-brand-600)" :
                    rule.variant === "warning" ? "var(--eco-warning-500)" : "var(--eco-danger-500)",
                }}
              />
              <span className="text-[13px]" style={{ color: "var(--eco-text)" }}>{rule.text}</span>
            </div>
          ))}
        </div>
      </SectionCard>
    ...
    <div>
      ...
      <SectionCard className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* Normal */}
          <div className="rounded-xl overflow-hidden" style={{ border: "2px solid var(--eco-success-500)" }}>
            <div className="px-4 py-2 flex items-center gap-2" style={{ background: "var(--eco-success-100)" }}>
            ...
            <div className="p-4" style={{ background: "var(--eco-bg)" }}>
              <div className="text-[11px] mb-1" style={{ color: "var(--eco-text-tertiary)" }}>{t("slaTimeRemaining")}</div>
              <div className="text-[28px] mb-3" style={{ color: "var(--eco-success-500)" }}>18:42:15</div>
              <div className="h-2 rounded-full mb-3" style={{ background: "var(--eco-neutral-200)" }}>
                <div className="h-2 rounded-full" style={{ width: "78%", background: "var(--eco-success-500)" }} />
              </div>
          ...
          {/* Warning */}
          <div className="rounded-xl overflow-hidden" style={{ border: "2px solid var(--eco-warning-500)" }}>
            <div className="px-4 py-2 flex items-center gap-2" style={{ background: "var(--eco-warning-100)" }}>
            ...
            <div className="p-4" style={{ background: "var(--eco-bg)" }}>
              <div className="text-[11px] mb-1" style={{ color: "var(--eco-text-tertiary)" }}>{t("slaTimeRemaining")}</div>
              <div className="text-[28px] mb-3" style={{ color: "var(--eco-warning-500)" }}>02:15:33</div>
              <div className="h-2 rounded-full mb-3" style={{ background: "var(--eco-neutral-200)" }}>
                <div className="h-2 rounded-full" style={{ width: "15%", background: "var(--eco-warning-500)" }} />
              </div>
              <div className="flex items-start gap-2 rounded-lg p-2 mb-3" style={{ background: "var(--eco-warning-100)" }}>
                <AlertTriangle size={14} className="shrink-0 mt-0.5" style={{ color: "var(--eco-warning-500)" }} />
          ...
          {/* Breached */}
          <div className="rounded-xl overflow-hidden" style={{ border: "2px solid var(--eco-danger-500)" }}>
            <div className="px-4 py-2 flex items-center gap-2" style={{ background: "var(--eco-danger-100)" }}>
            ...
            <div className="p-4" style={{ background: "var(--eco-bg)" }}>
              <div className="text-[11px] mb-1" style={{ color: "var(--eco-text-tertiary)" }}>{t("slaTimeRemaining")}</div>
              <div className="text-[28px] mb-3" style={{ color: "var(--eco-danger-500)" }}>00:00:00</div>
              <div className="h-2 rounded-full mb-3" style={{ background: "var(--eco-danger-100)" }}>
                <div className="h-2 rounded-full" style={{ width: "100%", background: "var(--eco-danger-500)" }} />
              </div>
              <div className="flex items-start gap-2 rounded-lg p-2 mb-3" style={{ background: "var(--eco-danger-100)" }}>
                <ShieldAlert size={14} className="shrink-0 mt-0.5" style={{ color: "var(--eco-danger-500)" }} />
      ...
      <SectionCard className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* Member sees */}
          <div className="rounded-xl p-4" style={{ background: "var(--eco-bg)", border: "1px solid var(--eco-border)" }}>
            <div className="text-[11px] mb-3" style={{ color: "var(--eco-text-tertiary)" }}>MEMBER VIEW</div>
            <div className="flex items-center gap-3 mb-3">
              <div className="w-8 h-8 rounded-full flex items-center justify-center" style={{ background: "var(--eco-brand-50)" }}>
                <CheckCircle2 size={16} style={{ color: "var(--eco-brand-600)" }} />
              </div>
              <div>
                <div className="text-[14px]" style={{ color: "var(--eco-text)" }}>{t("accessGranted")}</div>
                <div className="text-[12px]" style={{ color: "var(--eco-text-tertiary)" }}>Beeline Family 30GB</div>
              </div>
            </div>
            <div className="rounded-lg p-3 mb-3" style={{ background: "var(--eco-warning-100)" }}>
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-[13px] font-medium" style={{ color: "var(--eco-warning-500)" }}>
                  {t("slaConfirmAccess")}
                </span>
              </div>
              <div className="text-[12px]" style={{ color: "var(--eco-text-secondary)" }}>
          ...
          {/* Breached state */}
          <div className="rounded-xl p-4" style={{ background: "var(--eco-bg)", border: "2px solid var(--eco-danger-500)" }}>
            <div className="text-[11px] mb-3" style={{ color: "var(--eco-danger-500)" }}>T_CONFIRM BREACHED</div>
            <div className="flex items-start gap-3 mb-3 rounded-lg p-3" style={{ background: "var(--eco-danger-100)" }}>
              <AlertCircle size={16} className="shrink-0 mt-0.5" style={{ color: "var(--eco-danger-500)" }} />
              <div>
                <div className="text-[13px] font-medium mb-1" style={{ color: "var(--eco-danger-500)" }}>
            ...
            <div className="text-[11px] px-2 py-1 rounded inline-block mb-3" style={{ background: "var(--eco-neutral-100)", color: "var(--eco-text-tertiary)" }}>
              {t("idempotentNote")}
            </div>
            <div className="flex gap-2">
              <Button variant="secondary" size="sm" className="flex-1" disabled>{t("viewTicket")}</Button>
              <Button variant="secondary" size="sm" className="flex-1" disabled>{t("contactSupport")}</Button>
            </div>
          </div>
        </div>
      </SectionCard>
      ...
      <SectionCard>
        ...
        <div className="flex flex-col gap-4">
          {/* Auto ticket */}
          <div className="rounded-xl overflow-hidden" style={{ border: "1px solid var(--eco-warning-500)" }}>
            <div className="flex items-center gap-3 px-4 py-3" style={{ background: "var(--eco-warning-100)" }}>
              <TicketCheck size={18} style={{ color: "var(--eco-warning-500)" }} />
              <div className="flex-1">
                <div className="text-[14px] font-medium" style={{ color: "var(--eco-warning-500)" }}>
              ...
              <Button variant="secondary" size="sm" disabled>{t("viewTicket")}</Button>
            </div>
          </div>

          {/* Auto dispute */}
          <div className="rounded-xl overflow-hidden" style={{ border: "1px solid var(--eco-danger-500)" }}>
            <div className="flex items-center gap-3 px-4 py-3" style={{ background: "var(--eco-danger-100)" }}>
              ...
              <Button variant="destructive" size="sm" disabled>{t("viewDetails")}</Button>
            </div>
          </div>

          {/* Idempotent note */}
          <div className="flex items-center gap-2 rounded-lg p-3" style={{ background: "var(--eco-brand-50)" }}>
...
function EdgeCases() {
  ...
  const colorMap = {
    warning: {
      bg: "var(--eco-warning-100)", border: "var(--eco-warning-500)", text: "var(--eco-warning-500)",
      iconBg: "var(--eco-warning-100)",
    },
    danger: {
      bg: "var(--eco-danger-100)", border: "var(--eco-danger-500)", text: "var(--eco-danger-500)",
      iconBg: "var(--eco-danger-100)",
    },
    info: {
      bg: "var(--eco-brand-50)", border: "var(--eco-brand-400)", text: "var(--eco-brand-600)",
  ...
  return (
    <div>
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 flex-wrap mb-1">
                    <span className="text-[16px]" style={{ color: "var(--eco-text)" }}>{c.title}</span>
                    <span
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  {c.flags.map((flag, fi) => (
                    <span
                      ...
                      style={{ background: "var(--eco-bg)", color: "var(--eco-text-secondary)", border: "1px solid var(--eco-border)" }}
                    >
      ...
      <SectionCard className="mt-6">
        ...
        <div className="flex flex-wrap gap-3">
          {[
            ...
            <Pill key={chip.label} variant={chip.variant}>{chip.label}</Pill>
          ))}
        </div>
        <div className="flex items-center gap-2 mt-4">
          {[t("refundRequested"), t("refundApproved"), t("refundProcessing"), t("refundCompleted")].map((label, i, arr) => (
            <div key={`tl-${i}`} className="flex items-center gap-2">
              ...
              <span className="text-[11px] whitespace-nowrap" style={{ color: i <= 1 ? "var(--eco-text)" : "var(--eco-text-tertiary)" }}>
                {label}
              </span>
              {i < arr.length - 1 && (
                <div className="w-8 h-px" style={{ background: i < 1 ? "var(--eco-primary)" : "var(--eco-neutral-300)" }} />
              )}
            </div>
          ))}
        </div>
      ...
      <SectionCard className="mt-6">
        ...
        <div className="max-w-md rounded-xl overflow-hidden" style={{ border: "2px solid var(--eco-danger-500)" }}>
          <div className="flex items-center gap-2 px-4 py-2" style={{ background: "var(--eco-danger-100)" }}>
