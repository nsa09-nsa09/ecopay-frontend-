    ...
    operators: [
      {
        name: 'Beeline',
        color: '#FFB800',
        coverage4G: 'excellent',
        coverage5G: 'good',
        avgSpeed: 48,
        shareablePlans: 6,
        cheapestPlan: 2490,
        bestFor: 'Speed & 5G coverage',
        overallScore: 92,
        bars: 5,
      },
      {
        ...
        shareablePlans: 5,
        cheapestPlan: 2990,
        bestFor: 'Premium plans, large data',
        overallScore: 88,
        bars: 4,
      },
      {
    ...
    operators: [
      {
        ...
        shareablePlans: 5,
        cheapestPlan: 2990,
        bestFor: 'Best coverage in capital',
        overallScore: 94,
        bars: 5,
      },
      {
  ...
  return (
    <div className="max-w-[480px] mx-auto">
      <SC className="text-center">
        ...
        <h2 className="text-[22px] mb-2" style={{ color: 'var(--eco-text)' }}>
          {t('geoPermTitle')}
        </h2>
        ...
        {/* Privacy note */}
        <div
          className="rounded-lg px-4 py-3 flex items-start gap-2 text-left"
            ...
            >
              ...
              <div className="flex items-center gap-1">
                <span className="text-[11px]" style={{ color: 'var(--eco-text-tertiary)' }}>
                  {CITY_DATA[city].operators.length} operators
                </span>
...
function ResultsView({ city }: { city: string }) {
  ...
  return (
    <div>
      {/* Location bar */}
      <div
        className="rounded-xl px-5 py-3 mb-5 flex items-center justify-between flex-wrap gap-3"
        style={{ background: 'var(--eco-surface)', border: '1px solid var(--eco-border)' }}
      >
        <div className="flex items-center gap-2">
          <div
          ...
          <div>
            ...
            <div className="text-[11px] tabular-nums" style={{ color: 'var(--eco-text-tertiary)' }}>
              {data.lat}, {data.lng}
            </div>
          </div>
        </div>
      ...
      {/* Winner banner */}
      <div
        className="rounded-xl px-5 py-4 mb-5 flex items-center gap-4"
        style={{ background: `${best.color}12`, border: `1px solid ${best.color}40` }}
      >
        <div
          ...
          <SC key={op.name} className="!p-0 overflow-hidden">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-[11px]" style={{ color: 'var(--eco-text-tertiary)' }}>
                  {t('geoBestFor')}: {op.bestFor}
                </div>
              </div>
              <div className="text-right">
                <div className="text-[20px] tabular-nums" style={{ color: 'var(--eco-text)' }}>
                  {op.overallScore}
                </div>
            ...
            >
              ...
              <div className="px-4 py-3">
                <div className="text-[10px] mb-2" style={{ color: 'var(--eco-text-tertiary)' }}>
                  4G {t('geoCoverage')}
                </div>
              ...
              <div className="px-4 py-3">
                ...
                <div className="flex items-baseline gap-1">
                  <span className="text-[22px] tabular-nums" style={{ color: 'var(--eco-text)' }}>
                    {op.avgSpeed}
                  </span>
                  <span className="text-[11px]" style={{ color: 'var(--eco-text-tertiary)' }}>
                    Mbps
                ...
                >
                  <div
                    ...
                    style={{
                      width: `${Math.min((op.avgSpeed / 60) * 100, 100)}%`,
                      background:
                        op.avgSpeed >= 45
                          ? 'var(--eco-success-500)'
                          : op.avgSpeed >= 30
              ...
              <div className="px-4 py-3">
                ...
                <div className="text-[22px] tabular-nums" style={{ color: 'var(--eco-primary)' }}>
                  {op.shareablePlans}
                </div>
                <div className="text-[10px]" style={{ color: 'var(--eco-text-tertiary)' }}>
                  rooms open
            ...
            <tbody>
              {sorted.map((op, idx) => (
                <tr
                  ...
                  style={{
                    borderBottom: '1px solid var(--eco-border)',
                    background: idx === 0 ? 'var(--eco-success-100)' : 'transparent',
                  }}
                >
      ...
      {/* Disclaimer */}
      <div
        className="rounded-xl px-5 py-3 flex items-start gap-2"
  ...
  return (
    <div className="max-w-[1200px] mx-auto px-6 py-10">
      ...
      <div className="mb-8">
        ...
        <p className="text-[16px] mb-4" style={{ color: 'var(--eco-text-secondary)' }}>
          {t('geoSubtitle')}
        </p>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {[
            ...
            <div key={s.id} className="flex items-center gap-2">
              <div
                ...
                style={{
                  background:
                    step === s.id || (s.id === 'prompt' && step === 'manual')
                      ? 'var(--eco-primary)'
                      : step === 'results'
                        ? 'var(--eco-success-100)'
                        : 'var(--eco-neutral-100)',
          ...
          {step === 'results' && (
            <button
              ...
              style={{ color: 'var(--eco-primary)', background: 'var(--eco-brand-50)' }}
            >
              Change city
            </button>
          )}
      ...
      {step === 'results' && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
          {[
            ...
            {
              n: `${CITY_DATA[city].operators.reduce((s, o) => s + o.shareablePlans, 0)}`,
              label: 'Shareable plans',
            },
            {
              n: `${fmt(Math.min(...CITY_DATA[city].operators.map((o) => o.cheapestPlan)))}`,
              label: 'From',
            },
          ].map((s) => (
            <div
      ...
      {step === 'prompt' && (
        <PermissionPrompt onAllow={handleAllow} onSkip={() => setStep('manual')} />
      )}
