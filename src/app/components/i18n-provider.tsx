...
const translations: Translations = {
  ...
  feedbackSubjectLabel: { ru: "Тема (необязательно)", kz: "Тақырып (міндетті емес)", en: "Subject (optional)" },
  feedbackSubjectPlaceholder: { ru: "Кратко — о чём", kz: "Қысқаша — не туралы", en: "Briefly — what about" },
  ...
  feedbackCharCount: { ru: "{{count}} / {{max}} символов", kz: "{{count}} / {{max}} таңба", en: "{{count}} / {{max}} characters" },
  feedbackSubmit: { ru: "Отправить", kz: "Жіберу", en: "Send" },
  feedbackSubmitted: { ru: "Спасибо! Ваше обращение принято.", kz: "Рахмет! Өтінішіңіз қабылданды.", en: "Thanks! Your message has been sent." },
  feedbackRateLimited: {
    ru: "Слишком много отправок. Попробуйте позже.",
    kz: "Тым көп жіберу. Кейінірек көріңіз.",
    en: "Too many submissions. Please try again later.",
  },
  feedbackSubmitFailed: { ru: "Не удалось отправить. Попробуйте снова.", kz: "Жіберу мүмкін болмады. Қайталап көріңіз.", en: "Couldn't send. Please try again." },
  feedbackMessageEmpty: { ru: "Сообщение не может быть пустым.", kz: "Хабарлама бос болмауы керек.", en: "Message can't be empty." },
  feedbackMessageTooLong: { ru: "Слишком длинное сообщение.", kz: "Хабарлама тым ұзақ.", en: "Message is too long." },
  feedbackMyList: { ru: "Мои обращения", kz: "Менің өтініштерім", en: "My feedback" },
  feedbackMyListEmpty: { ru: "Вы ещё ничего не отправляли.", kz: "Сіз ештеңе жібермедіңіз.", en: "You haven't sent anything yet." },
  ...
  adminFeedbackTitle: { ru: "Обращения пользователей", kz: "Пайдаланушы өтініштері", en: "User feedback" },
  adminFeedbackSearchPlaceholder: { ru: "Поиск по теме или тексту", kz: "Тақырып немесе мәтін бойынша іздеу", en: "Search subject or text" },
  ...
  adminFeedbackSelect: { ru: "Выберите обращение из списка", kz: "Тізімнен өтінішті таңдаңыз", en: "Select a submission to view details" },
  adminFeedbackEmpty: { ru: "Обращений не найдено.", kz: "Өтініштер табылмады.", en: "No feedback found." },
  ...
  adminFeedbackNotePlaceholder: { ru: "Внутренний комментарий", kz: "Ішкі түсініктеме", en: "Internal note" },
  adminFeedbackSetStatus: { ru: "Изменить статус", kz: "Мәртебесін өзгерту", en: "Change status" },
  adminFeedbackSaveChanges: { ru: "Сохранить изменения", kz: "Өзгерістерді сақтау", en: "Save changes" },
  adminFeedbackUpdateFailed: { ru: "Не удалось обновить.", kz: "Жаңарту мүмкін болмады.", en: "Update failed." },
  ...
  currencyGbp: { ru: "Фунт стерлингов (GBP, £)", kz: "Фунт стерлинг (GBP, £)", en: "Pound Sterling (GBP, £)" },
  currencyRub: { ru: "Рубль (RUB, ₽)", kz: "Рубль (RUB, ₽)", en: "Ruble (RUB, ₽)" },
  currencyUzs: { ru: "Узбекский сум (UZS, сум)", kz: "Өзбек сомы (UZS, сум)", en: "Uzbek Sum (UZS, soʼm)" },
  currencyKgs: { ru: "Киргизский сом (KGS, сом)", kz: "Қырғыз сомы (KGS, сом)", en: "Kyrgyz Som (KGS, som)" },
  priceAmountLabel: { ru: "Сумма", kz: "Сома", en: "Amount" },
  priceKztEquivalent: { ru: "≈ {{amount}} в тенге", kz: "≈ {{amount}} теңгеде", en: "≈ {{amount}} in tenge" },
  priceFxUnavailable: { ru: "Курс валют недоступен", kz: "Валюта курсы қолжетімсіз", en: "FX rate unavailable" },
  priceFxUpdatedAt: { ru: "Курсы обновлены: {{time}}", kz: "Курстар жаңартылды: {{time}}", en: "Rates updated: {{time}}" },
  ...
  memberStatCompletedRooms: { ru: "Завершённые комнаты", kz: "Аяқталған бөлмелер", en: "Completed rooms" },
  ...
  memberStatReviewsReceived: { ru: "Полученные отзывы", kz: "Алынған пікірлер", en: "Reviews received" },
  ...
  memberRecentEventsEmpty: { ru: "Событий пока нет", kz: "Әзірге оқиғалар жоқ", en: "No events yet" },
  memberDashboardLoadFailed: { ru: "Не удалось загрузить статистику", kz: "Статистиканы жүктеу мүмкін болмады", en: "Unable to load stats" },
  memberNoUpcomingPayment: { ru: "Нет запланированных платежей", kz: "Жоспарланған төлемдер жоқ", en: "No upcoming payments" },

  // ===== Admin: dashboard — extended KPIs =====
  kpiUniqueVisitorsToday: { ru: "Уникальные гости сегодня", kz: "Бүгінгі бірегей қонақтар", en: "Unique visitors today" },
  kpiUniqueVisitors30d: { ru: "Уникальные гости за 30 дней", kz: "30 күндегі бірегей қонақтар", en: "Unique visitors (30d)" },
  kpiPageViews30d: { ru: "Просмотры за 30 дней", kz: "30 күндегі қаралымдар", en: "Page views (30d)" },
  kpiConversion30d: { ru: "Конверсия гость → регистрация", kz: "Конверсия қонақ → тіркелу", en: "Visitor → signup conversion" },
  kpiAvgRoomFill: { ru: "Средняя заполняемость комнат", kz: "Бөлмелердің орташа толтыруы", en: "Avg room fill rate" },
  kpiAvgMembersPerRoom: { ru: "В среднем участников на комнату", kz: "Бөлмеге орташа қатысушылар", en: "Avg members per room" },
  kpiActiveSubsValue: { ru: "Стоимость активных подписок", kz: "Белсенді жазылымдар құны", en: "Active subscriptions value" },
  kpiNewRooms30d: { ru: "Новые комнаты за 30 дней", kz: "30 күндегі жаңа бөлмелер", en: "New rooms (30d)" },
  ...
  dashboardChartTrafficTitle: { ru: "Трафик: уникальные гости и просмотры", kz: "Трафик: бірегей қонақтар және қаралымдар", en: "Traffic: unique visitors and page views" },
  ...
  dashboardMetricUniqueVisitors: { ru: "Уникальные гости", kz: "Бірегей қонақтар", en: "Unique visitors" },
  ...
  dashboardSectionAudience: { ru: "Аудитория и спрос", kz: "Аудитория мен сұраныс", en: "Audience & Demand" },
  dashboardPopularServicesTitle: { ru: "Популярные подписки", kz: "Танымал жазылымдар", en: "Popular subscriptions" },
  dashboardOperatorDistributionTitle: { ru: "Распределение по операторам", kz: "Операторлар бойынша бөлу", en: "Operator distribution" },
  dashboardCurrencyDistributionTitle: { ru: "Валюты комнат", kz: "Бөлме валюталары", en: "Room currencies" },
  dashboardCategoryDistributionTitle: { ru: "Категории", kz: "Санаттар", en: "Categories" },
  dashboardRoomStatusDistributionTitle: { ru: "Статусы комнат", kz: "Бөлме мәртебелері", en: "Room statuses" },
