...
adminAboutApexLink: {
  ...
  slugTaken: { ru: 'Занято', kz: 'Бос емес', en: 'Taken' },
  slugInvalid: { ru: 'Некорректный slug', kz: 'Жарамсыз', en: 'Invalid' },
  slugReserved: { ru: 'Зарезервировано', kz: 'Резервте', en: 'Reserved' },
  slugHint: {
    ru: 'Только строчные латинские буквы, цифры и дефис (3–30).',
  ...
  reasonCode: { ru: 'Причина', kz: 'Себеп', en: 'Reason' },
  ...
  colId: { ru: 'Номер', kz: 'Нөмір', en: 'ID' },
  colEntity: { ru: 'Объект', kz: 'Нысан', en: 'Entity' },
  colScore: { ru: 'Риск', kz: 'Тәуекел', en: 'Risk' },
...
paymentIntentValid24h: {
  ...
  adminStoriesFormEdit: {
    ru: 'Редактирование актуального',
    kz: 'Өзектіні өңдеу',
    en: 'Editing highlight',
  },
  ...
  adminStoriesFieldEmoji: {
    ru: 'Эмодзи без фото',
    kz: 'Фото жоқ кездегі эмодзи',
    en: 'Fallback emoji',
  },
  adminStoriesFieldGradient: {
    ru: 'Фон без фото',
    kz: 'Фото жоқ кездегі фон',
    en: 'Fallback background',
  },
  adminStoriesImageHint: {
    ru: 'PNG/JPG, до 5 МБ. Вертикальный формат 9:16. Для новой записи картинка загрузится после сохранения.',
    kz: 'PNG/JPG, 5 МБ-қа дейін. Тік 9:16 форматы. Жаңа жазбада сурет сақтаудан кейін жүктеледі.',
    en: 'PNG/JPG, up to 5 MB. Vertical 9:16 format. For a new item, the image uploads after save.',
  },
  ...
  adminStoriesSaveSuccess: {
    ru: 'Актуальное сохранено',
    kz: 'Өзекті сақталды',
    en: 'Highlight saved',
  },
  adminStoriesDeleteSuccess: {
    ru: 'Актуальное удалено',
    kz: 'Өзекті жойылды',
    en: 'Highlight deleted',
  },
  ...
  howItWorksStep2Title: {
    ru: 'Укажите данные для подключения',
    kz: 'Қосылу деректерін көрсетіңіз',
    en: 'Enter connection details',
  },
  howItWorksStep2Desc: {
    ru: 'Для мобильного семейного тарифа укажите номер телефона. Если сервис подключает по приглашению — укажите email.',
    kz: 'Мобильді отбасылық тариф үшін телефон нөмірін көрсетіңіз. Сервис шақыру арқылы қосылса, email көрсетіңіз.',
    en: 'For a mobile family plan, enter the phone number. If the service connects members by invitation, enter an email.',
  },
